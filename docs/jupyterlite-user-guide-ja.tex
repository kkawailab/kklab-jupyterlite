...
\begin{enumerate}
  ...
  \item \filepath{jupyterlite/jupyterlite_beginner_tutorial_with_exercises_v2.ipynb}
    --- JupyterとPythonの基本
  \item \filepath{numpy/numpy_beginner_tutorial.ipynb} --- 配列と計算
  \item \filepath{pandas/pandas_beginner_tutorial.ipynb} --- 表形式データ
  \item \filepath{matplotlib/matplotlib_beginner_tutorial.ipynb} --- グラフ
...
\begin{enumerate}
  \item \filepath{pandas/pandas_intermediate_tutorial.ipynb}
  \item \filepath{scipy/scipy_stats_beginner_tutorial.ipynb}
  \item \filepath{scipy/scipy_stats_intermediate_tutorial.ipynb}
  \item \filepath{seaborn/seaborn_beginner_tutorial.ipynb}
  \item \filepath{statsmodels/statsmodels_jupyterlite_tutorial_v2.ipynb}
...
\begin{enumerate}
  \item \filepath{numpy/numpy_intermediate_tutorial.ipynb}
  \item \filepath{sklearn/sklearn_beginner_tutorial.ipynb}
  \item \filepath{sklearn/sklearn_intermediate_tutorial.ipynb}
...
\begin{enumerate}
  \item \filepath{matplotlib/matplotlib_beginner_tutorial.ipynb}
  \item \filepath{seaborn/seaborn_beginner_tutorial.ipynb}
  \item \filepath{folium/leaflet_folium_jupyterlite_tutorial.ipynb}
  \item \filepath{folium/leaflet_folium_jupyterlite_tutorial_tokai.ipynb}
...
\filepath{jupyterlite/jupyterlite_beginner_tutorial_with_exercises_v2.ipynb}
  & Jupyter操作、Python入門、演習\\
\filepath{numpy/numpy_beginner_tutorial.ipynb} & NumPy配列、演算、統計関数\\
\filepath{pandas/pandas_beginner_tutorial.ipynb} & Series、DataFrame、抽出、絞り込み\\
\filepath{matplotlib/matplotlib_beginner_tutorial.ipynb} & 基本グラフ\\
\filepath{seaborn/seaborn_beginner_tutorial.ipynb} & 統計可視化の基本\\
\filepath{scipy/scipy_stats_beginner_tutorial.ipynb} & 記述統計、確率分布\\
\filepath{sklearn/sklearn_beginner_tutorial.ipynb} & 前処理、回帰、分類、評価\\
\filepath{ipywidgets/ipywidgets_beginner_tutorial.ipynb} & 対話ウィジェット\\
\midrule
\multicolumn{2}{l}{\bfseries 中級・発展}\\
\filepath{numpy/numpy_intermediate_tutorial.ipynb} & 線形代数、ブロードキャスト\\
\filepath{pandas/pandas_intermediate_tutorial.ipynb} & 集計、欠損値、結合、時系列\\
\filepath{matplotlib/matplotlib_intermediate_tutorial.ipynb} & 複数図、軸、注釈、スタイル\\
\filepath{seaborn/seaborn_intermediate_tutorial.ipynb} & FacetGrid、PairGrid、クラスターマップ\\
\filepath{scipy/scipy_stats_intermediate_tutorial.ipynb} & 検定、相関、分散分析\\
\filepath{sklearn/sklearn_intermediate_tutorial.ipynb} & アンサンブル、調整、クラスタリング\\
\filepath{statsmodels/statsmodels_jupyterlite_tutorial_v2.ipynb}
  & 回帰、ロジスティック回帰、時系列\\
\midrule
\multicolumn{2}{l}{\bfseries 総合版・特殊トピック}\\
\filepath{pandas/pandas_jupyterlite_tutorial.ipynb} & pandasの基礎から時系列まで\\
\filepath{matplotlib/matplotlib_jupyterlite_tutorial.ipynb}
  & matplotlibの基礎から保存まで\\
\filepath{folium/leaflet_folium_jupyterlite_tutorial.ipynb} & 地図表示\\
\filepath{folium/leaflet_folium_jupyterlite_tutorial_tokai.ipynb}
  & 東海4県のGeoJSON可視化\\
\filepath{jupyterlite/jupyterlite_xeus_r_stats_practice.ipynb}
  & Rによる統計検定\\
\midrule
...
対象は
\filepath{jupyterlite/jupyterlite_xeus_r_stats_practice.ipynb}です。
...
\vfill
\begin{center}
  \color{GuideGray}\small
  本ガイドはLuaLaTeXで組版されています。
\end{center}
