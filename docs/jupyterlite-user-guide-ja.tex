...
\begin{enumerate}
  ...
  \item \filepath{statsmodels/statsmodels_tutorial.ipynb}
...
\begin{enumerate}
  ...
  \item \filepath{seaborn/seaborn_beginner_tutorial.ipynb}
  \item \filepath{folium/folium_beginner_tutorial.ipynb}
  \item \filepath{folium/folium_tokai_geojson_tutorial.ipynb}
...
\filepath{statsmodels/statsmodels_tutorial.ipynb}
  & 回帰、ロジスティック回帰、時系列\\
\midrule
\multicolumn{2}{l}{\bfseries 総合版・特殊トピック}\\
\filepath{pandas/pandas_complete_tutorial.ipynb} & pandasの基礎から時系列まで\\
\filepath{matplotlib/matplotlib_complete_tutorial.ipynb}
  & matplotlibの基礎から保存まで\\
\filepath{folium/folium_beginner_tutorial.ipynb} & 地図表示\\
\filepath{folium/folium_tokai_geojson_tutorial.ipynb}
  & 東海4県のGeoJSON可視化\\
